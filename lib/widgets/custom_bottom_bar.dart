...
class CustomBottomBarState extends State<CustomBottomBar> {
  ...
  List<BottomMenuModel> bottomMenuList = [
    ...
    BottomMenuModel(
      icon: ImageConstant.imgNavAiChatbot,
      activeIcon: ImageConstant.imgNavAiChatbot,
      title: "lbl_ai_chatbot".tr,
      type: BottomBarEnum.Aichatbot,
    )
  ];
            ...
            activeIcon: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    bottomMenuList[index].title ?? "",
                    style: CustomTextStyles.labelLargePoppinsSecondaryContainer
                        .copyWith(
                      color: theme.colorScheme.secondaryContainer,
                    ),
                  ),
